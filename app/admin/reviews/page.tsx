            ...
            <div className="bg-white border border-stone-100 rounded-3xl p-5 shadow-sm flex items-center gap-4 relative overflow-hidden group">
              ...
              <div className="space-y-0.5">
                ...
                <p className="text-2xl font-black text-stone-900">
                  {totalReviews > 0
                    ? `${Math.round(
                        (paginatedReviews.filter(r => r.rating >= 4).length / paginatedReviews.length) * 100 || 100
                      )}%`
                    : "100%"}
                </p>
                ...
                >
                  ...
                  <div className="border-t border-stone-100 mt-5 pt-3.5 flex justify-end">
                    <button
                      ...
                      className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-red-50 hover:bg-red-650 text-red-650 hover:text-white border border-red-100 hover:border-red-600 transition-all active:scale-95 cursor-pointer text-[10px] font-bold uppercase tracking-wider"
        ...
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction 
              ...
              disabled={isDeleting}
              className="bg-red-600 hover:bg-red-750 text-white cursor-pointer rounded-xl text-xs py-2 px-4 shadow-none flex items-center justify-center gap-2"
            >
              {isDeleting ? (
                <>
